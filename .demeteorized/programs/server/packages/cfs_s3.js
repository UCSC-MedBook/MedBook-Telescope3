 ...
 // options = _.omit(options, validS3ServiceParamKeys);                                                     // 92
  ...
  return new FS.StorageAdapter(name, options, {                                                             // 110
    ...
    createWriteStream: function(fileKey, options) {                                                         // 136
      options = options || {};                                                                              // 137
                                                                                                            // 138
      // We dont support array of aliases                                                                   // 139
      delete options.aliases;                                                                               // 140
      // We dont support contentType                                                                        // 141
      delete options.contentType;                                                                           // 142
      // We dont support metadata use Metadata?                                                             // 143
      delete options.metadata;                                                                              // 144
                                                                                                            // 145
      // Set options                                                                                        // 146
      var options = FS.Utility.extend({                                                                     // 147
        Bucket: bucket,                                                                                     // 148
        Key: folder + fileKey,                                                                              // 149
        fileKey: fileKey,                                                                                   // 150
        ACL: defaultAcl                                                                                     // 151
      }, options);                                                                                          // 152
                                                                                                            // 153
      return S3.createWriteStream(options);                                                                 // 154
    },                                                                                                      // 155
    remove: function(fileKey, callback) {                                                                   // 156
                                                                                                            // 157
      S3.deleteObject({                                                                                     // 158
        Bucket: bucket,                                                                                     // 159
        Key: folder + fileKey                                                                               // 160
      }, function(error) {                                                                                  // 161
        callback(error, !error);                                                                            // 162
      });                                                                                                   // 163
    },                                                                                                      // 164
    watch: function() {                                                                                     // 165
      throw new Error("S3 storage adapter does not support the sync option");                               // 166
    }                                                                                                       // 167
  });                                                                                                       // 168
};                                                                                                          // 169
                                                                                                            // 170
